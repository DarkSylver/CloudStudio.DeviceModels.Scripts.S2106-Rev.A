...
function getEndpoints(deviceAddress, endpoints) {
    ...
    endpoints.addEndpoint("1", "Air Temperature", endpointType.temperatureSensor);
    var e = endpoints.addEndpoint("2", "pH", endpointType.genericSensor);
    e.variableTypeId = 1289;
}
